          ...
          col.updateItems = function (activeIndex, translate, transition, valueCallbacks) {
              ...
              */
              ...
              if (valueCallbacks || typeof valueCallbacks === 'undefined') {
                  ...
                  col.text = selectedItem.html();
                  p.nowSelect = selectedItem.attr('data-picker-id');
      ...
      p.columnHTML = function (col, onlyItems) {
          ...
          if (col.divider) {
              ...
              for (var j = 0; j < col.values.length; j++) {
                  if(typeof col.values[j] == 'object'){
                      columnItemsHTML += '<div class="picker-item" data-picker-id="' + col.values[j].id + '"data-picker-value="' + col.values[j].text + '">' + (col.displayValues ? col.displayValues[j] : col.values[j].text) + '</div>';
                  }else{
                      columnItemsHTML += '<div class="picker-item" data-picker-id="' + col.values[j].id + '"data-picker-value="' + col.values[j] + '">' + (col.displayValues ? col.displayValues[j] : col.values[j]) + '</div>';
                  }
              }
